const WA="916388250630";let product="";
...
function update(){if(!product)return; phCalc();let s="<b>"+product+"</b><br>Package: "+((document.getElementById("tier")||{}).value||"Standard")+"<br>Quantity: "+qty.value+"<br>Customer: "+(customer.value||"—");if(product==="T-Shirt")s+="<br>"+shirtType.value+" | "+shirtColour.value+" | "+shirtSize.value+" | "+shirtPrint.value;let f=design.files[0];s+="<br>Design: "+(f?f.name:"नहीं लगाया");preview.innerHTML=s}
